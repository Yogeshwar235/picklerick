...
def deserialize():
    ...
    try:
        ...
        return jsonify({'deserialized_data': deserialized_data, 'disassembly': disassembly_str(pickled_data_bytes)})
...
def disassembly_str(pickled_data_bytes):
    ...
    dis_output_str = dis_output.getvalue()
    print(dis_output_str)
    return dis_output_str
